...
def _get_dataset(scale):
    ...
    df = pd.read_csv("D:/univesity/foqelisans/final_project/code/Adversarially-Learned-Anomaly-Detection1/data/kddcup.data_10_percent_corrected", header=None, names=col_names)
